...
// How big should this services Queue be? Small queue b/c this service
// receives only the ES_INIT event
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "GamePlayHSM.h"
// the name of the Init function
#define SERV_1_INIT InitMasterSM
// the name of the run function
#define SERV_1_RUN RunMasterSM
// How big should this services Queue be? Large queue because Sharp sensor
// can flood framework with events
...
typedef enum
{
  ...
  EV_OBJECT_DETECTED_RETRO,   /* object detected w/ retroreflective sensor */
  EV_OBJECT_DETECTED_SHARP,   /* object detected w/ Sharp sensor */
  EV_LINE_HIT,                /* wire current detected */
  EV_SWITCH_HIT,              /* wall detected using limit switches */
  EV_ATTACK_GOAL_DETECTED,    /* photodiode receives appropriate signal */
  EV_DEFEND_GOAL_DETECTED,    /* photodiode receives appropriate signal */
  EV_RELOADER_DETECTED,       /* photodiode receives appropriate signal */
  EV_STATE_CHANGE,            /* REF indicates state change */
  EV_SCORE_UPDATE,            /* asking for score from REF */
  EV_STATE_UPDATE,            /* asking for state from REF */
  EV_EARLY_DEFENSE,           /* going to defense before REF says */
  EV_EOM                      /* indicating SPI transmit finished */
}ES_EventType_t;
...
#define EVENT_CHECK_LIST Check4LimitSwitches, Check4SharpEvents, Check4Wire
...
// to different timers if the need arises. Keep these definitions close to // the definitions for the response functions to make it easier to check
// that the timer number matches where the timer event will be routed
// These symbolic names should be changed to be relevant to your application

#define REF_QUERY_TIMER 0
#define REF_WAIT_TIMER 1
#define DARK_HORSE_TIMER 2
#define CONTROL_LAW_TIMER 3
#define SHOOTING_TIMER 4
#define BALL_WHEEL_TIMER 5
#define RELOADING_ROTATE_TIMER 6
#define TURNING_TOWARDS_WIRE_TIMER 7
#define FORWARD_STOP_TIMER 8
#define TURN_STOP_TIMER 9
#define LED_TIMER 10
#define HANDSHAKE_TIMER 11
#define GAME_TIMER_2 12
#define RETROREFLECTIVE_TIMER 13
#define DEF_TIMER 14
#define GAME_TIMER 15
