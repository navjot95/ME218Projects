...
#define SERV_0_HEADER "StepperMotorService.h"
// the name of the Init function
#define SERV_0_INIT InitStepperMotorService
// the name of the run function
#define SERV_0_RUN RunStepperMotorService
...
// the name of the Init function
#define SERV_2_INIT InitButtonDebounce
// the name of the run function
#define SERV_2_RUN RunButtonDebounce
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0
#define DIST_LIST0 PostStepperMotorService
#endif
#if NUM_DIST_LISTS > 1
...
#define TIMER1_RESP_FUNC PostStepperMotorService
