...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "SensorUpdate.h" //TestHarnessService1.h"
// the name of the Init function
#define SERV_1_INIT InitSensorUpdate //InitTestHarnessService1
// the name of the run function
#define SERV_1_RUN RunSensorUpdate // RunTestHarnessService1
// How big should this services Queue be?
