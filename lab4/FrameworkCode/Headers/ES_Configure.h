...
#define SERV_0_HEADER "MorseElementService.h"
// the name of the Init function
#define SERV_0_INIT InitMorseElementService
// the name of the run function
#define SERV_0_RUN RunMorseElementService
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "DecodeMorseService.h"
// the name of the Init function
#define SERV_2_INIT InitDecodeMorseService
// the name of the run function
#define SERV_2_RUN RunDecodeMorseService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "LCDService.h"
// the name of the Init function
#define SERV_3_INIT InitLCDService
// the name of the run function
#define SERV_3_RUN RunLCDService
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                ES_MORSE_RISING_EDGE,
                ES_MORSE_FALLING_EDGE,
                ES_CALIBRATION_COMPLETED,
                ES_EOC_DETECTED, 
                DB_BUTTON_DOWN,
                DB_BUTTON_UP,
                ES_LCD_PUTCHAR,
...
#endif
#if NUM_DIST_LISTS > 1 
#define DIST_LIST1 PostMorseElementService, PostDecodeMorseService
#endif
#if NUM_DIST_LISTS > 2 
#define DIST_LIST2 PostDecodeMorseService, PostMorseElementService
#endif
#if NUM_DIST_LISTS > 3 
...
#define EVENT_CHECK_LIST Check4Keystroke, CheckMorseEvents, CheckButtonEvents
...
#define TIMER0_RESP_FUNC PostMorseElementService
#define TIMER1_RESP_FUNC PostButtonService
...
#define TIMER15_RESP_FUNC PostLCDService
